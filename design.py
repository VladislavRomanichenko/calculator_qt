...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/ui/icons/calculator.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"border: none;")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/sqrt.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_sqrt.setIcon(icon1)
        self.btn_sqrt.setIconSize(QSize(32, 32))

        self.layout_buttons.addWidget(self.btn_sqrt, 1, 2, 1, 1)

        self.btn_div_x = QPushButton(self.centralwidget)
        self.btn_div_x.setObjectName(u"btn_div_x")
        sizePolicy2.setHeightForWidth(self.btn_div_x.sizePolicy().hasHeightForWidth())
        self.btn_div_x.setSizePolicy(sizePolicy2)
        self.btn_div_x.setCursor(QCursor(Qt.PointingHandCursor))

        self.layout_buttons.addWidget(self.btn_div_x, 1, 0, 1, 1)

        self.btn_sqare = QPushButton(self.centralwidget)
        self.btn_sqare.setObjectName(u"btn_sqare")
        sizePolicy2.setHeightForWidth(self.btn_sqare.sizePolicy().hasHeightForWidth())
        self.btn_sqare.setSizePolicy(sizePolicy2)
        self.btn_sqare.setCursor(QCursor(Qt.PointingHandCursor))
        icon2 = QIcon()
        icon2.addFile(u":/icons/icons/sqare.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_sqare.setIcon(icon2)
        self.btn_sqare.setIconSize(QSize(40, 40))

        self.layout_buttons.addWidget(self.btn_sqare, 1, 1, 1, 1)
        ...
        self.btn_moddiv = QPushButton(self.centralwidget)
        self.btn_moddiv.setObjectName(u"btn_moddiv")
        sizePolicy2.setHeightForWidth(self.btn_moddiv.sizePolicy().hasHeightForWidth())
        self.btn_moddiv.setSizePolicy(sizePolicy2)
        self.btn_moddiv.setCursor(QCursor(Qt.PointingHandCursor))

        self.layout_buttons.addWidget(self.btn_moddiv, 0, 0, 1, 1)
        ...
        self.layout_buttons.addWidget(self.btn_clear, 0, 2, 1, 1)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/icons/backspace.svg", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_div_x.setText(QCoreApplication.translate("MainWindow", u"1/x", None))
        self.btn_sqare.setText("")
...
#endif // QT_CONFIG(shortcut)
        self.btn_moddiv.setText(QCoreApplication.translate("MainWindow", u"%", None))
